...
export default authMiddleware({
  ...
  beforeAuth: (req) => {
    ...
    if (isMobile && req.nextUrl.pathname.startsWith('/') && !req.nextUrl.pathname.startsWith('/api') && !req.nextUrl.pathname.startsWith('/sign-') && !req.nextUrl.pathname.includes('mobile')) {
